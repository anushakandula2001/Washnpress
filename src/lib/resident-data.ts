...
export const orderTrackingEvents: Record<string, TrackingEvent[]> = {
  WNP12345: [
    ...
    {
      stage: "Wash",
      label: "In Wash / Ironing",
      timestamp: "16 May, 2:00 PM",
      completed: false,
      active: true,
    },
    {
...
export const walletTransactions: WalletTransaction[] = [
  ...
  },
  {
    id: "txn-2",
    type: "debit",
    description: "Payment - Order #WNP12330",
    date: "10 Jul 2026",
    amountInr: 150,
  },
  {
  ...
  },
  {
    id: "txn-4",
    type: "debit",
    description: "Add-on: Dry Cleaning",
    date: "1 Jul 2026",
    amountInr: 200,
  },
];
...
export const addonServices: AddonService[] = [
  {
    id: "addon-1",
    name: "Dry Cleaning",
    description: "Premium dry clean for suits & sarees",
    priceInr: 80,
    icon: "shirt",
  },
  {
    id: "addon-2",
    name: "Shoe Cleaning",
    description: "Deep clean for leather & canvas shoes",
    priceInr: 150,
    icon: "footprints",
  },
  {
    ...
    description: "Targeted stain removal treatment",
    priceInr: 50,
    icon: "sparkles",
  },
  {
    ...
    description: "Same-day delivery within 12 hours",
    priceInr: 199,
    icon: "zap",
  },
  {
    ...
    description: "Premium softener for all garments",
    priceInr: 30,
    icon: "droplets",
  },
];
...
export const residentNotifications = [
  {
    ...
    body: "Your pickup is scheduled for tomorrow 10:00 AM – 12:00 PM",
    unread: true,
  },
  {
    id: "n2",
    title: "Order In Progress",
    body: "Order #WNP12345 is now in wash",
    unread: true,
  },
  {
    id: "n3",
    title: "Wallet Credit",
    body: "₹100 referral bonus added to your wallet",
    unread: false,
  },
];
...
export function formatPickupDisplay(pickup: ResidentPickup): string {
  ...
  if (pickupDate.toDateString() === tomorrow.toDateString()) {
    ...
    dayLabel = pickupDate.toLocaleDateString("en-IN", {
      weekday: "short",
      day: "numeric",
      month: "short",
    });
