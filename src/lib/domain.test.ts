...
describe("domain rules", () => {
  ...
  it("totals selected add-on services correctly", () => {
    const total = calculateAddonServiceTotal([
      { id: "addon-1", name: "Dry Cleaning", priceInr: 80 },
      { id: "addon-3", name: "Stain Treatment", priceInr: 50 },
      { id: "addon-5", name: "Fabric Softener", priceInr: 30 },
    ]);
